...
description_tr: "Web uygulamalarını browser-use ajanları ile otonom olarak debug eden bir MCP Server."
...
body_tr: |-
  ...
  * `setup_browser_state`
  ...
  1. Ön koşullar (genellikle gerekli değildir):
   ...
   - jq: `brew install jq` 
  2. [API anahtarı aldıktan sonra (ücretsiz)](https://www.operative.sh/mcp) yükleyiciyi çalıştırın
     - [playwright](https://github.com/microsoft/playwright) yükler 
     - [uv'yi yükler](https://astral.sh/)
     - Kod editörünüz (Cursor/Cline/Windsurf) için JSON ekler! 
  ```bash
  curl -LSf https://operative.sh/install.sh -o install.sh && bash install.sh && rm install.sh
  ```
  3. Favori IDE'nizi ziyaret edin ve değişiklikleri uygulamak için yeniden başlatın
  4. Sohbet modunda web eval agent tool'unu çağırmak için bir prompt gönderin! örneğin 
  ```bash
  ...
  ```
  5. Aşağıdaki JSON'ı ilgili kod editörünüze API anahtarı ile ekleyin 
  ...
  3. operative.sh/mcp adresinden API anahtarınızı alın
