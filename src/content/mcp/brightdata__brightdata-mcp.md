...
body_tr: |-
  <div align="center">
    ...
    <p>
      ...
      <a href="#-pricing--modes">Fiyatlandırma</a> •
    ...
    <div align="center">
      ...
      <p>
        Bir paketin en son sürümüne mi ihtiyacınız var? İş akışınızdan çıkmadan README'sini okumak mı istiyorsunuz?<br/>
        <b>Code</b> tool grubu, kodlama ajanlarına yapılandırılmış, güvenilir paket meta verilerini talep üzerine sunuyor —<br/>
        scraping yok, eski cache yok, sadece ajanınızın akıllı bağımlılık kararları vermesi için ihtiyacı olan veriler.
      </p>
      <table>
        <tr>
          <td align="center"><b>npm</b><br/><sub>Paket sürümleri, README'ler, meta veriler ve bağımlılıklar</sub></td>
          <td align="center"><b>PyPI</b><br/><sub>Python paket bilgileri, sürümler ve proje detayları</sub></td>
        </tr>
      </table>
    ...
    <div align="center">
      ...
      <p>
        Ajanınızdan doğrudan önde gelen LLM'leri sorgulayın ve yapılandırılmış, markdown biçimlendirilmiş yanıtlar alın.<br/>
        <b>Generative Engine Optimization (GEO)</b> için nihai geri bildirim döngüsü — AI tarafından oluşturulan<br/>
        önerileri izleyin, LLM'ler arasında marka sözlerini takip edin ve AI'ın ürünlerinizi nasıl algıladığını anlayın.
      </p>
      <table>
        <tr>
          <td align="center"><b>ChatGPT</b><br/><sub>AI tarafından oluşturulan içgörüler, alıntılar ve öneriler</sub></td>
          <td align="center"><b>Grok</b><br/><sub>X verilerine dayanan gerçek zamanlı AI analizi</sub></td>
          <td align="center"><b>Perplexity</b><br/><sub>Kaynaklarla arama destekli AI yanıtları</sub></td>
        </tr>
      </table>
  ...
  **Web MCP**, AI asistanlarına gerçek web yetenekleri vermenin kapınızdır. Artık güncellenmiş olmayan yanıtlar yok, artık "gerçek zamanlı bilgilere erişemiyorum" diye söylemek yok — sadece sorunsuzca çalışan, güvenilir web erişimi.
  ...
  <div align="center">
    <table>
      <tr>
        <td align="center">✅ <strong>Herhangi bir LLM ile Çalışır</strong><br/><sub>Claude, GPT, Gemini, Llama</sub></td>
        <td align="center">🛡️ <strong>Hiçbir Zaman Engellenmez</strong><br/><sub>Enterprise sınıfı engelleme kaldırma</sub></td>
        <td align="center">🚀 <strong>5.000 Ücretsiz İstek</strong><br/><sub>Aylık</sub></td>
        <td align="center">⚡ <strong>Sıfır Yapılandırma</strong><br/><sub>Kutudan çıktığı gibi çalışır</sub></td>
      </tr>
    </table>
  </div>
  ...
  - 🤖 **AI Ajanları** - Gerçekten web'i gezebilen ajanlar oluşturun
  - 💻 **Kodlama Ajanları** - npm/PyPI paketlerini, sürümleri ve README'leri gerçek zamanlı olarak arayın
  ...
  **Claude Desktop'ta Kurulum:**
  ...
  <div align="center">
    <table>
      <tr>
        <th width="33%">⚡ Hızlı Mod (Ücretsiz katman)</th>
        <th width="33%">💎 Pro Mod</th>
        <th width="34%">🔧 Özel Mod</th>
      </tr>
      <tr>
        <td align="center">
          <h3>$0/ay</h3>
          <p><strong>5.000 istek</strong></p>
          <hr/>
          <p>✅ Web Arama<br/>
          ✅ Web unlocker ile Scraping<br/>
          ✅ AI sıralı Discover arama<br/>
          ❌ Browser Otomasyonu<br/>
          ❌ Web veri araçları</p>
          <br/>
          <code>Varsayılan Mod</code>
        </td>
        <td align="center">
          <h3>Kullandıkça Öde</h3>
          <p><strong>Hızlı modun tümü artı 60+ araç</strong></p>
          <hr/>
          <p>✅ Browser Kontrolü<br/>
          ✅ Web Veri API'leri<br/>
          <br/>
          <br/>
          <br/>
        ...
        <td align="center">
          <h3>Kullanıma Dayalı</h3>
          <p><strong>İhtiyacınız olan araçları seçin</strong></p>
          <hr/>
          <p>✅ Tool gruplarını birleştirin<br/>
          ✅ Bireysel araçlar ekleyin<br/>
          ❌ Pro uygunluğunu geçersiz kılar</p>
          <br/>
  ...
  - Mod önceliği: `PRO_MODE=true` (tüm araçlar) → `GROUPS` / `TOOLS`
    (beyaz liste) → varsayılan hızlı mod (temel araç seti).
  ...
  <table>
    <tr>
      ...
      <th align="left">Öne çıkan araçlar</th>
    </tr>
    <tr>
      <td><code>ecommerce</code></td>
      <td>Perakende ve market verileri</td>
    ...
    <tr>
      ...
      <td>Sosyal, topluluk ve yaratıcı içgörüleri</td>
    ...
    <tr>
      ...
      <td>Bright Data Scraping Browser otomasyonu araçları</td>
    ...
    <tr>
      ...
      <td>Finansal istihbarat verileri</td>
      <td><code>web_data_yahoo_finance_business</code></td>
    </tr>
    <tr>
      <td><code>business</code></td>
      <td>Şirket ve konum istihbaratı verileri</td>
  ...
  <table>
    <tr>
      ...
      <td>📄 <b>Temiz Markdown</b><br/>AI'ya hazır içerik çıkarımı</td>
    </tr>
    <tr>
      <td>🌍 <b>Küresel Erişim</b><br/>Coğrafi kısıtlamaları otomatik olarak atla</td>
      <td>🛡️ <b>Anti-Bot Koruması</b><br/>Hiçbir zaman engellenmez veya hız sınırlandırılmaz</td>
    </tr>
    <tr>
      <td>🤖 <b>Browser Otomasyonu</b><br/>Gerçek tarayıcıları uzaktan kontrol et (Pro)</td>
  ...
  ✅ "Bugünün New York için hava tahmini"
  ✅ "Bu hafta hangi filmler vizyona giriyor?"
  ✅ "Bugün Twitter'da popüler konular nelerdir?"
  ...
  | **Web Veri API'leri** | `web_data_*` | Yapılandırılmış veri çıkarımı |
  ...
  ```json
  {
    "mcpServers": {
      "Bright Data": {
        ...
        "env": {
          "API_TOKEN": "your-token-here",
          "PRO_MODE": "true",              // Tüm 60+ araçları etkinleştir
          "RATE_LIMIT": "100/1h",          // Özel hız sınırlaması
          "WEB_UNLOCKER_ZONE": "custom",   // Özel unlocker bölgesi
          "BROWSER_ZONE": "custom_browser", // Özel browser bölgesi
          "POLLING_TIMEOUT": "600"         // Polling timeout'u saniye cinsinden (varsayılan: 600)
        }
      }
    }
  }
  ...
  | `PRO_MODE` | Tüm 60+ araçları etkinleştir | `false` | `true` |
  | `RATE_LIMIT` | Özel hız sınırlaması | sınırsız | `100/1h`, `50/30m` |
  | `WEB_UNLOCKER_ZONE` | Özel Web Unlocker bölge adı | `mcp_unlocker` | `my_custom_zone` |
  | `BROWSER_ZONE` | Özel Browser bölge adı | `mcp_browser` | `my_browser_zone` |
  | `POLLING_TIMEOUT` | web_data_* araçları polling timeout'u (saniye) | `600` | `300`, `1200` |
  | `BASE_TIMEOUT` | Temel araçlar için istek timeout'u saniye cinsinden (arama ve scrape) | Limit yok | `60`, `120` |
      ...
      <tr>
        <td align="center">
          <a href="https://github.com/brightdata-com/brightdata-mcp/issues">
            ...
            <sub>Hataları ve özellikleri bildirin</sub>
          </a>
        </td>
        <td align="center">
          <a href="https://docs.brightdata.com/mcp-server/overview">
            <strong>📚 Belgeler</strong><br/>
            <sub>Tam kılavuzlar</sub>
          </a>
        </td>
        <td align="center">
          <a href="mailto:support@brightdata.com">
            <strong>✉️ E-posta</strong><br/>
