...
description_tr: "YouTube video bilgilerini çıkart ve dönüştür."
      ...
      <tr>
        <td align="center" width="33%" valign="top" style="vertical-align: top; height: 250px;">
          <div style="height: 100%; display: flex; flex-direction: column; justify-content: space-between;">
            <div>
              <h2>Strata</h2>
              <p><strong>AI agentniz için akıllı bağlayıcılar, context window'u optimize edin</strong></p>
            </div>
            <div>
        ...
        <td align="center" width="33%" valign="top" style="vertical-align: top; height: 250px;">
          <div style="height: 100%; display: flex; flex-direction: column; justify-content: space-between;">
            <div>
              ...
              <p><strong>100+ hazır entegrasyon, OAuth desteğiyle birlikte</strong></p>
            </div>
            <div>
        ...
        <td align="center" width="33%" valign="top" style="vertical-align: top; height: 250px;">
          <div style="height: 100%; display: flex; flex-direction: column; justify-content: space-between;">
            <div>
              <h2>MCP Sandbox</h2>
              <p><strong>LLM eğitimi ve RL için ölçeklenebilir MCP ortamları</strong></p>
            </div>
            <div>
