...
description_tr: "MCP sunucuları için bir reverse proxy ve yönetim katmanı, Kubernetes ortamlarında ölçeklenebilir, session-farkında yönlendirme ve lifecycle yönetimi sağlar."
