...
description_tr: "Scrapeless Model Context Protocol servisi, Google SERP API'ye bağlanan bir MCP server connector görevi görerek MCP ekosistemi içinde web araması yapılmasını sağlar. Bu sayede başka bir platforma geçmenize gerek kalmaz."
