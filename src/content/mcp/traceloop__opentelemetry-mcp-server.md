...
description_tr: "OpenTelemetry arka ucuyla (Datadog, Grafana, Dynatrace, Traceloop vb.) bağlantı kurmak için bir MCP sunucusu."
...
body_tr: |-
  ...
  **Aksiyon halinde gör:**
  ...
  - [Araçlar Referansı](#araçlar-referansı)
  - [Örnek Sorgular](#örnek-sorgular)
  - [Yaygın İş Akışları](#yaygın-iş-akışları)
