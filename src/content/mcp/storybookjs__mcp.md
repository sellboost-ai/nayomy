...
description_tr: "Ajanların UI bileşenleriniz için hikaye yazmasını ve test etmesini otomatik olarak sağlayın."
...
body_tr: |-
  ...
  6. Bu ilk istemden sonra, her değişiklik yaptığınızda Storybook otomatik olarak yeniden başlatılır. Tamamen hazır olana kadar bekleyin, ardından _"Run the tool again"_ istemini kullanabilirsiniz.

  Araç çağrılarında daha düşük seviye kontrol sağlamak için [MCPJam'ın inspector'ını](https://docs.mcpjam.com/getting-started) da kullanabilirsiniz.
  ...
  **Göreli içeri aktarmalarda her zaman dosya uzantılarını ekleyin:**
  ...
  Bu proje sürüm yönetimi için [Changesets](https://github.com/changesets/changesets) kullanır:
  ...
  - **Fikirler & Özellik İstekleri**: [Tartışma başlatın](https://github.com/storybookjs/mcp/discussions/new?category=ideas)
  - **Hata Raporları**: [Bir sorun açın](https://github.com/storybookjs/mcp/issues/new)
  - **Sorular**: [GitHub Discussions](https://github.com/storybookjs/mcp/discussions) içinde sorun
