...
description_tr: "Model Context Protocol (MCP) sunucusu, Feishu OAuth doğrulaması ile entegre olup uzak bağlantıları destekler ve blok oluşturma, içerik güncelleme gibi kapsamlı Feishu belge yönetimi araçları sağlar."
