...
description_tr: "MCP kullanan çok aracılı sistemler oluşturmak için bir framework olup, koordine edilmiş AI işbirliği, görev yönetimi, paylaşılan context ve RAG yetenekleri sunmaktadır."
...
body_tr: |-
  ...
  >
  > 💬 **Topluluğa Katılın**: [Discord](https://discord.gg/7Jm7nrhjGn) üzerinden bize katılın, yardım alın, deneyimlerinizi paylaşın ve multi-agent sistemleri oluşturan diğer geliştiricilerle işbirliği yapın.
  ...
  **MCP ile VS Code**:
  MCP uzantısını kullanarak Agent-MCP'yi doğrudan editör iş akışınıza entegre edin.
