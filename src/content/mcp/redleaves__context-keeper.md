...
description_tr: "LLM tabanlı bağlam ve hafıza yönetimi, geniş arama + hassas yeniden sıralama RAG mimarisi ile sunuluyor. Çok boyutlu retrieval (vector/timeline/knowledge graph), kısa/uzun vadeli hafıza ve tam MCP desteğini (HTTP/WebSocket/SSE) içeriyor."
