...
body_tr: |-
  ...
  - 🔧 **[Güçlü MCP Server](https://github.com/zillow/auto-mobile/blob/HEAD/docs/features/mcp-server/index.md)**: AutoMobile, MCP tool çağrıları aracılığıyla kapsamlı [actions](https://github.com/zillow/auto-mobile/blob/HEAD/docs/features/mcp-server/actions.md) ve hızlı [observations](https://github.com/zillow/auto-mobile/blob/HEAD/docs/features/mcp-server/observation.md) ile [interaction loop](https://github.com/zillow/auto-mobile/blob/HEAD/docs/features/mcp-server/interaction-loop.md)'u yönlendirmek için sağlar.
  ...
  - ✍️ **[Otomatik Test Yazma](https://github.com/zillow/auto-mobile/blob/HEAD/docs/features/test-authoring/index.md)**: Test yazma modunda kullanıldığında AutoMobile sizin için testler yazacaktır. Testleri yazmanın tek yoludur.
  - 🧪 **[Test Yürütme](https://github.com/zillow/auto-mobile/blob/HEAD/docs/features/test-execution/index.md)** - Testleri yerel olarak veya CI'da ek altyapı olmadan çalıştırın.
  ...
  - 💻 [Kurulum & Başlangıç](https://github.com/zillow/auto-mobile/blob/HEAD/docs/installation.md) - AutoMobile [npm'de yayımlanmıştır](https://www.npmjs.com/package/auto-mobile) ve test ettiğimiz ajanlar için talimatlarımız bulunmaktadır.
  - 📝 [Değişiklik Günlüğü](https://github.com/zillow/auto-mobile/blob/HEAD/CHANGELOG.md) - yakında gelecek
  
  ## Katkıda Bulunma
  
  - [Davranış Kuralları](https://github.com/zillow/auto-mobile/blob/HEAD/CODE_OF_CONDUCT.md)
  - [Sorumlu ifşa & kullanım](https://github.com/zillow/auto-mobile/blob/HEAD/SECURITY.md)
  - [Katkıda Bulunma](https://github.com/zillow/auto-mobile/blob/HEAD/.github/CONTRIBUTING.md) - yakında gelecek
  
  # Teşekkür 
  
  AutoMobile'ı kullanmaya devam ederek, [uyarıları ve sorumlu kullanım gerekliliklerini kabul ve onaylıyorsunuz](https://github.com/zillow/auto-mobile/blob/HEAD/SECURITY.md).
---
