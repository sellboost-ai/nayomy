...
description_tr: "Kubernetes Model Context Protocol (MCP) sunucusu; API kaynak keşfi, kaynak yönetimi, pod logları, metrikler ve olayları içeren standartlaştırılmış bir arayüz aracılığıyla Kubernetes kümelerine etkileşim kurmak için araçlar sunar."
