...
description_tr: "iOS simülatörleriyle (iPhone, iPad vb.) doğal dil komutları aracılığıyla etkileşim kurmak için LLM'leri etkinleştiren bir Model Context Protocol (MCP) sunucusu."
