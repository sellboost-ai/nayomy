...
description_tr: "Claude Vision API için optimize edilmiş hızlı ekran görüntüsü alma aracı. Tam sayfaları 1072x1072 parçalara otomatik olarak bölerek yapay zeka işlenmesi için en iyi sonuçları sağlar; dinamik içerik için yapılandırılabilir viewport ve bekleme stratejileri sunar."
