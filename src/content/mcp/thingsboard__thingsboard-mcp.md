...
description_tr: "ThingsBoard MCP Server, LLM'ler ve AI ajanlarının ThingsBoard IoT platformunuzla etkileşim kurması için doğal dil arayüzü sunmaktadır."
...
This project is licensed under the Apache License 2.0 — see the [LICENSE](https://github.com/thingsboard/thingsboard-mcp/tree/HEAD/LICENSE) file for details.
