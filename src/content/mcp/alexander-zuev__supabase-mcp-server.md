...
description_tr: "Supabase MCP Server, SQL sorgusu yürütme ve veritabanı keşif araçlarıyla desteklenen bir çözüm"
category: "Databases"
...
body_tr: |-
  ...
  > 🌅 pypi üzerinden 17.000'den fazla kurulum ve Smithery.ai'de 30.000'e yakın indirilme — kısacası çok eğlenceliydi! 🥳
  > Bu sunucuyu geçtiğimiz birkaç ay boyunca kullanan herkese teşekkürler ve umarım sizin için faydalı olmuştur.
  > Supabase kendi [resmi MCP sunucusunu](https://github.com/supabase-community/supabase-mcp) yayınladığından beri,
  > bu sunucuyu artık aktif olarak geliştirmemeye karar verdim. Resmi MCP sunucusu aynı derecede özellik açısından zengin ve gelecekte
  > daha birçok özellik eklenecektir. Kontrol etmeye değer!


  <p class="center-text">
    <strong>Query MCP, IDE'nizin SQL çalıştırmasını, şema değişikliklerini yönetmesini, Supabase Management API'sini çağırmasını ve Auth Admin SDK'yı kullanmasını — tümü yerleşik güvenlik kontrolleriyle — güvenli bir şekilde yapmasını sağlayan açık kaynaklı bir MCP sunucusudur.</strong>
  </p>
  ...
  <p class="center-text">
    <a href="#başlamak">Başlamak</a> •
    <a href="#özellik-özeti">Özellik özeti</a> •
  ...
  `uv` üzerinden kurmayı planlıyorsanız, [yüklü](https://docs.astral.sh/uv/getting-started/installation/#__tabbed_1_1) olduğundan emin olun.
  ...
  **Windows**
    - PostgreSQL 16+ dosyasını https://www.postgresql.org/download/windows/ adresinden indirin ve kurun
    - Kurulum sırasında "PostgreSQL Server" ve "Command Line Tools" seçeneğinin işaretli olduğundan emin olun
  ...
  Bu MCP sunucusuna bağlanmak için Smithery.ai nasıl kullanılacağına dair tüm talimatları [burada](https://smithery.ai/server/@alexander-zuev/supabase-mcp-server) bulabilirsiniz.
  ...
  > 🔑 **Önemli**: v0.4'ten beri MCP sunucusu bu MCP sunucusunu kullanmak için [thequery.dev](https://thequery.dev) adresinden ücretsiz olarak alabilir bir API anahtarı gerektirmektedir.
  ...
  Yapılandırma doğruysa, yeşil bir nokta göstergesi ve sunucu tarafından sunulan araçların sayısını göreceksiniz.
  ![Başarılı Cursor yapılandırması nasıl görünür](https://github.com/user-attachments/assets/45df080a-8199-4aca-b59c-a84dc7fe2c09)
  ...
  ![Başarılı Windsurf yapılandırması nasıl görünür](https://github.com/user-attachments/assets/322b7423-8c71-410b-bcab-aff1b143faa4)
  ...
  ![Başarılı Windsurf yapılandırması nasıl görünür](https://github.com/user-attachments/assets/500bcd40-6245-40a7-b23b-189827ed2923)
  ...
  ![Cline'da başarılı yapılandırması nasıl görünür](https://github.com/user-attachments/assets/6c4446ad-7a58-44c6-bf12-6c82222bbe59)
