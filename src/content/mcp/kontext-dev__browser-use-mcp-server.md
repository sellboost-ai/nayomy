...
description_tr: "browser-use uygulamasını MCP server olarak paketlenmiş halinde sunuyoruz, SSE transport ile çalışır. Chromium'u Docker'da çalıştırmak için Dockerfile ve VNC sunucusu içerir."
