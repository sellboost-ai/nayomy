...
description_tr: "Playwright kullanan, tarayıcı otomasyonu ve web scraping için MCP sunucusu."
...
body_tr: |-
  <div align="center" markdown="1">
    <table>
      ...
      <tr>
        <td align="center"><sub>MseeP.ai Güvenlik Değerlendirmesi</sub></td>
      </tr>
    </table>
  </div>
  <hr>
  ...
  **143 cihazı destekler:** iPhone, iPad, Pixel, Galaxy ve masaüstü tarayıcıları viewport, user-agent, dokunma olayları ve cihaz piksel oranlarının uygun emülasyonu ile.
  ...
  📚 [Cihaz Hızlı Referansını Görüntüle](https://executeautomation.github.io/mcp-playwright/docs/playwright-web/Device-Quick-Reference) | [İstem Rehberi](https://executeautomation.github.io/mcp-playwright/docs/playwright-web/Resize-Prompts-Guide)

  ## Ekran Görüntüsü
  ![Playwright + Claude](https://raw.githubusercontent.com/executeautomation/mcp-playwright/HEAD/image/playwright_claude.png)

  ## [Belgeler](https://executeautomation.github.io/mcp-playwright/) | [API Referansı](https://executeautomation.github.io/mcp-playwright/docs/playwright-web/Supported-Tools)
  ...
  [Smithery](https://smithery.ai/server/@executeautomation/playwright-mcp-server) aracılığıyla Claude Desktop için Playwright MCP'yi otomatik olarak kurun:
  ...
  **Çözüm:**
  ...
  Evals paketi, index.ts dosyasını çalıştıran bir mcp istemcisi yükler, bu nedenle testler arasında yeniden derlemek gerekli değildir. Ortam değişkenlerini npx komutunun başına ön ekle yaparak yükleyebilirsiniz. Tam belgeler [burada](https://www.mcpevals.io/docs) bulunabilir.
