...
body_tr: |-
  ...
  **Çok sevdiklerini öldür.** Bir sayfa trafik alırsa ama dönüşüm yapmazsa, düzelt ya da birleştir. Her ikisini de almazsa, sil. İçerik borcu gerçektir.
  ...
  - Hedef anahtar kelimelerin %30+'u 6 ay içinde sayfa 1'e ulaşıyor
  - Her içerik parçasının ölçülebilir bir sonraki adımı var
  - Editoryal takvim kendini yönetiyor — yazarlar ne yazacaklarını ve neden yazacaklarını biliyorlar
---
