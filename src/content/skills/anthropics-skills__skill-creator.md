...
description_tr: "Sıfırdan yeni yetenekler oluşturun, mevcut yetenekleri düzenleyin ve geliştirin, performanslarını ölçün. Kullanıcılar bir skill oluştururken, düzenlerken veya optimize ederken, evals çalıştırarak test ederken, varyans analizi ile skill performansını karşılaştırırken veya daha iyi tetikleme doğruluğu için skill açıklamalarını optimize ederken kullanın."
