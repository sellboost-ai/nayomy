...
description_tr: "Faebryk component kütüphanesinin yapısını, `_F.py` dosyasının nasıl oluşturulduğunu ve yeni kütüphane modülleri eklerken uyulması gereken kuralları ve invariant'ları açıklar. Kütüphane bileşenleri, trait'ler veya modül tanımlamalarını eklerken veya değiştirirken kullanın."
