...
body_tr: |-
  ...
  **Detaylı örneklem boyutu tabloları ve süre hesaplamaları için**: [references/sample-size-guide.md](https://github.com/alirezarezvani/claude-skills/blob/HEAD/references/sample-size-guide.md) dosyasına bakın
  ...
  **Şablonlar için**: [references/test-templates.md](https://github.com/alirezarezvani/claude-skills/blob/HEAD/references/test-templates.md) dosyasına bakın
...
**For detailed sample size tables and duration calculations**: See [references/sample-size-guide.md](https://github.com/alirezarezvani/claude-skills/blob/HEAD/references/sample-size-guide.md)
...
**For templates**: See [references/test-templates.md](https://github.com/alirezarezvani/claude-skills/blob/HEAD/references/test-templates.md)
