...
description_tr: "Claude Code ajanları ile tüm projelerinizde git worktree'leri oluşturun, yönetin ve temizleyin. Kullanıcı \"create worktree\", \"spin up worktrees\", \"new worktree for X\", \"worktree status\", \"cleanup worktrees\", \"sync worktrees\" dediğinde veya paralel geliştirme branch'leri istediğinde bu skill'i kullanın. Worktree branch'inden PR oluştururken de aktif hale gelir (registry'i PR numarasıyla günceller). Worktree oluşturma, dependency yönetimi ve proje senkronizasyonunu otomatikleştirir."
