...
description_tr: "Rube MCP (Composio) aracılığıyla Chmeetings görevlerini otomatikleştirin. Her zaman mevcut şemaları için önce araçları arayın."
...
body_tr: |-
  ...
  **Rube MCP'yi Al**: İstemci konfigürasyonunuzda MCP sunucusu olarak `https://rube.app/mcp` ekleyin. API anahtarlarına gerek yok — sadece endpoint'i ekleyin ve çalışır.
  ...
  | Bağlan | `RUBE_MANAGE_CONNECTIONS` ile `chmeetings` araç seti |
