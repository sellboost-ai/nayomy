...
description_tr: "Yüksek tasarım kalitesiyle üretim seviyesinde ve özgün frontend arayüzleri oluşturun. Web bileşenleri, sayfalar, posterler veya uygulamalar geliştirmek istendiğinde (web siteleri, landing sayfaları, gösterge panelleri, React bileşenleri, HTML/CSS düzenlemeleri veya herhangi bir web UI'nin stillendirilmesi gibi) bu yeteneği kullanın. Jenerik AI estetiğinden kaçınarak yaratıcı, parlak kod ve UI tasarımları üretir."
category: "Design"
repo: "theodo-group/debug-that"
stars: 158
url: "https://github.com/theodo-group/debug-that/blob/HEAD/.agents/skills/frontend-design/SKILL.md"
