...
When a term is resolved, update `CONTEXT.md` right there. Don't batch these up — capture them as they happen. Use the format in [CONTEXT-FORMAT.md](https://github.com/mattpocock/skills/blob/HEAD/CONTEXT-FORMAT.md).
...
If any of the three is missing, skip the ADR. Use the format in [ADR-FORMAT.md](https://github.com/mattpocock/skills/blob/HEAD/ADR-FORMAT.md).
