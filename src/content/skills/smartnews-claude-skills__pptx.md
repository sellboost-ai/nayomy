...
description_tr: "Sunumlar oluşturmak, düzenlemek ve analiz etmek için tasarlanmış araçlar. Claude, sunum dosyaları (.pptx) ile yeni sunumlar oluşturmak, içerik düzenlemek, düzenler ile çalışmak, yorum veya sunucu notları eklemek ve diğer tüm sunum görevlerini gerçekleştirilebilir."
category: "Document"
