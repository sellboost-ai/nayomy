...
body_tr: |-
  ...
  **Adımlar:**
  ...
  2. **Epik YAML Oluştur** - Hikaye oluşturucu için epiki yapılandır:
     ```yaml
     epic:
       title: "Kullanıcı Panosu"
       description: "Kullanıcı aktivitesi ve metrikleri için kapsamlı panel"
       personas: ["yönetici", "standart-kullanici"]
       features:
         - "Aktivite akışı"
         - "Kullanım metrikleri"
         - "Ayarlar paneli"
  ...
  **Örnek:**
  ...
  epic:
    title: "Kullanıcı Panosu"
    description: "Kullanıcı aktivitesi, temel metrikleri ve hesap ayarlarını gösteren gerçek zamanlı panel"
    personas: ["yönetici", "standart-kullanici"]
    features:
      - "Gerçek zamanlı aktivite akışı"
      - "Grafikli temel metrikleri gösterme"
  ...
  **Adımlar:**
  ...
  5. **INVEST'i Doğrula** - Her hikayeyi kontrol et:
     ...
     - **Değerli**: Kullanıcı veya iş değeri sunar
