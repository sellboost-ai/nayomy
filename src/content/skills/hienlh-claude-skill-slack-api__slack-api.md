...
description_tr: "Slack mesajlarını, thread'leri, kanalları okuyun ve Python API üzerinden ek dosyaları indirin. Slack URL'lerini (https://*.slack.com/archives/*/p*) gördüğünüzde veya Slack ile etkileşim kurmanız gerektiğinde kullanın."
