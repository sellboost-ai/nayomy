...
description_tr: "dbg CLI debugger ile uygulamalarınızı hata ayıklayın. Node.js (V8/CDP), Bun (WebKit/JSC) ve LLDB (DAP) ile native kod desteği sunar. Çalışma zamanı hatalarını adım adım incelemek, değişken değerlerini belirli noktalarda kontrol etmek, breakpoint ve koşullu breakpoint ayarlamak, duraklatılmış bağlamda expression'ları değerlendirmek ve JS kodunda yeniden başlatmadan sıcak yamalar uygulamak için kullanın."
category: "Design"
