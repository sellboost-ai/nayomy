...
description_en: "Automate Booqable tasks via Rube MCP (Composio). Always search tools first for current schemas."
...
body_tr: |-
  ...
  **Rube MCP'yi Alın**: İstemci konfigürasyonunuzda `https://rube.app/mcp` adresini bir MCP sunucusu olarak ekleyin. API anahtarı gerekmez — sadece endpoint'i ekleyin ve çalışır.
  ...
  | Bağlan | `RUBE_MANAGE_CONNECTIONS` ile `booqable` araç seti |
