...
description_en: "Automate Boloforms tasks via Rube MCP (Composio). Always search tools first for current schemas."
description_tr: "Boloforms görevlerini Rube MCP (Composio) aracılığıyla otomatikleştirin. Her zaman mevcut şemaları bulmak için önce araçları arayın."
category: "Development"
repo: "ComposioHQ/awesome-claude-skills"
stars: 64919
url: "https://github.com/ComposioHQ/awesome-claude-skills/blob/HEAD/composio-skills/boloforms-automation/SKILL.md"
...
related_files: []
body_tr: |-
  # Boloforms Otomasyonu Rube MCP aracılığıyla
  
  Composio'nun Boloforms toolkit'i aracılığıyla Rube MCP ile Boloforms işlemlerini otomatikleştirin.
  
  **Toolkit dokümanları**: [composio.dev/toolkits/boloforms](https://composio.dev/toolkits/boloforms)
  
  ## Ön Koşullar
  
  - Rube MCP bağlı olmalıdır (RUBE_SEARCH_TOOLS kullanılabilir)
  - `RUBE_MANAGE_CONNECTIONS` aracılığıyla aktif Boloforms bağlantısı ve `boloforms` toolkit'i
  ...
  **Rube MCP'yi edinin**: `https://rube.app/mcp` adresini MCP sunucusu olarak istemci yapılandırmanıza ekleyin. API anahtarı gerekmez — sadece endpoint'i ekleyin ve çalışır.
  ...
  2. `RUBE_MANAGE_CONNECTIONS` öğesini `boloforms` toolkit'i ile çağırın
  ...
  Bu, kullanılabilir tool slug'ları, giriş şemalarını, önerilen yürütme planlarını ve bilinen sorunları döndürür.
  ...
  - **Her zaman önce arayın**: Tool şemaları değişebilir. `RUBE_SEARCH_TOOLS` çağrısı yapmadan asla tool slug'larını veya argümanlarını sabit kodlamayın
  ...
  | İşlem | Yaklaşım |
  |-------|---------|
  | Tool'ları bulun | Boloforms'a özgü use case ile `RUBE_SEARCH_TOOLS` |
  | Bağlan | `RUBE_MANAGE_CONNECTIONS` ve `boloforms` toolkit'i ile |
