...
description_en: "Automate Chatbotkit tasks via Rube MCP (Composio). Always search tools first for current schemas."
description_tr: "Rube MCP (Composio) aracılığıyla Chatbotkit görevlerini otomatikleştirin. Güncel schemaları için her zaman önce araçları arayın."
category: "Development"
repo: "ComposioHQ/awesome-claude-skills"
stars: 64852
url: "https://github.com/ComposioHQ/awesome-claude-skills/blob/HEAD/composio-skills/chatbotkit-automation/SKILL.md"
...
related_files: []
body_tr: |-
  # Chatbotkit Otomasyonu Rube MCP ile

  Composio'nun Chatbotkit toolkit'i aracılığıyla Rube MCP üzerinden Chatbotkit işlemlerini otomatikleştirin.

  **Toolkit dokümantasyonu**: [composio.dev/toolkits/chatbotkit](https://composio.dev/toolkits/chatbotkit)

  ## Ön Koşullar

  - Rube MCP bağlı olmalıdır (RUBE_SEARCH_TOOLS kullanılabilir)
  - `RUBE_MANAGE_CONNECTIONS` aracılığıyla aktif Chatbotkit bağlantısı `chatbotkit` toolkit'i ile
  - Her zaman mevcut tool şemalarını almak için önce `RUBE_SEARCH_TOOLS` çağırın

  ## Kurulum

  **Rube MCP'yi Alın**: MCP sunucusu olarak `https://rube.app/mcp` adresini istemci konfigürasyonunuza ekleyin. API anahtarları gerekmez — sadece endpoint'i ekleyin ve çalışır.

  1. `RUBE_SEARCH_TOOLS` yanıt verdiğini doğrulayarak Rube MCP'nin kullanılabilir olduğunu kontrol edin
  2. `RUBE_MANAGE_CONNECTIONS` çağırın `chatbotkit` toolkit'i ile
  ...
  - **Her zaman önce arama yapın**: Tool şemaları değişir. `RUBE_SEARCH_TOOLS` çağrısı yapmadan tool slug'ları veya argümanları hiçbir zaman hardcode etmeyin
  ...
  | İşlem | Yaklaşım |
  |-----------|----------|
  | Tool'ları bul | `RUBE_SEARCH_TOOLS` Chatbotkit'e özgü use case ile |
  | Bağlan | `RUBE_MANAGE_CONNECTIONS` `chatbotkit` toolkit'i ile |
