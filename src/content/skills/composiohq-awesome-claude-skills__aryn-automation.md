...
description_en: "Automate Aryn tasks via Rube MCP (Composio). Always search tools first for current schemas."
...
body_tr: |-
  ...
  **Rube MCP'yi Edinin**: MCP sunucu yapılandırmanızda `https://rube.app/mcp` adresini MCP sunucusu olarak ekleyin. API anahtarı gerekmez — endpoint'i ekleyin ve çalışır.
  ...
  | Bağlan | `aryn` toolkit'i ile `RUBE_MANAGE_CONNECTIONS` |
