...
body_tr: |-
  ...
  // Proje farklı bir organizasyonu takip ediyorsa bu yapısal desenleri zorlama.
  // Mevcut proje mimarisine tutarlılık sağlamaya odaklanın ve Flutter en iyi uygulamalarını uygulayın.

  // Flutter En İyi Uygulamaları

  const flutterBestPractices = [
      "Mevcut proje mimarisine uyum sağlarken temiz kod ilkelerini koruyun",
      "Flutter 3.x özellikleri ve Material 3 tasarımını kullanın",
      "BLoC deseniyle temiz mimari uygulayın",
      "Uygun state management ilkelerini takip edin",
      "Uygun dependency injection kullanın",
      "Uygun hata işleme uygulayın",
      "Platform spesifik tasarım kılavuzlarını takip edin",
  ...
  2. Either tipiyle uygun hata işleme uygulayın
  3. Uygun adlandırma kurallarını takip edin
  4. Uygun widget bileşimini kullanın
  5. GoRouter kullanarak uygun routing uygulayın
  6. Uygun form doğrulaması kullanın
  7. BLoC ile uygun state management takip edin
  8. GetIt kullanarak uygun dependency injection uygulayın
  9. Uygun asset yönetimi kullanın
  10. Uygun test uygulamalarını takip edin
  `;
  ...
  2. Mümkün olduğunda const constructor'ları kullanın
  3. Uygun widget key'lerini uygulayın
  4. Uygun layout ilkelerini takip edin
  5. Uygun widget yaşam döngüsü metodlarını kullanın
  6. Uygun hata sınırlarını uygulayın
  7. Uygun performans optimizasyon tekniklerini kullanın
  8. Uygun erişilebilirlik kılavuzlarını takip edin
  `;

  // Performans Kılavuzu

  const performanceGuidelines = `
  1. Uygun görüntü önbelleğe almayı kullanın
  2. Uygun list view optimizasyonunu uygulayın
  3. Uygun build metodları optimizasyonunu kullanın
  4. Uygun state management desenleri takip edin
  5. Uygun bellek yönetimini uygulayın
  6. Gerektiğinde uygun platform kanallarını kullanın
  7. Uygun derleme optimizasyon tekniklerini takip edin
  `;

  // Test Kılavuzu

  const testingTestingGuidelines = `
  1. İş mantığı için unit test yazın
  2. UI bileşenleri için widget test uygulayın
  3. Özellik testi için integration test kullanın
  4. Uygun mock stratejileri uygulayın
  5. Uygun test coverage araçlarını kullanın
  6. Uygun test adlandırma kurallarını takip edin
  7. Uygun CI/CD testi uygulayın
  `;
  ```
---
