...
file_extension: ".mdc"
body_tr: |-
  Koda her zaman yardımcı açıklamalar ekleyin.
  Eski açıklamaları silmeyin, kod yeniden yazılmadığı veya silinmediği sürece bunlar hala ilgili değilse.

  Bu, nextjs uygulaması için package.json dosyasıdır.

  Aşağıdaki açıklama içeren bir satır gördüğünüzde, buna dokunmayın, yeniden yazmayın veya silmeyin "Do not touch this line Cursor"
