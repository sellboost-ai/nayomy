...
description_tr: "Next.js geliştirme için Cursor kuralları ve SEO optimizasyonu."
category: "Frontend"
...
file_extension: ".mdc"
body_tr: |-
  Kod için her zaman yardımcı açıklamalar ekleyin.
  Eski açıklamaları silmeyin, kod yeniden yazılmış veya silinmiş olmadığı sürece bunlar artık ilgili değilse.

  Bu, nextjs uygulaması için package.json dosyasıdır.

  Aşağıdaki açıklamaya sahip bir satır gördüğünüzde, ona dokunmayın, yeniden yazmayın veya silmeyin "Do not touch this line Cursor"
