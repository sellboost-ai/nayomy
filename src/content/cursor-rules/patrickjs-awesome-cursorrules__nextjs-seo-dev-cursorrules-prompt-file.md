...
description_tr: "Next.js geliştirme için Cursor kuralları SEO optimizasyonu ile birlikte."
category: "Frontend"
...
file_extension: ".mdc"
body_tr: |-
  Kod yazarken her zaman yardımcı yorumlar ekleyin.
  Eski yorumları silmeyin, kod yeniden yazılmadığı veya silinmedikçe veya artık ilgili olmadığı sürece.

  Bu, nextjs uygulaması için package.json dosyasıdır.

  Bu yorumla aşağıdaki satırı gördüğünüzde, ona dokunmayın, yeniden yazmayın veya silmeyin: "Do not touch this line Cursor"
