...
description_tr: "Next.js geliştirmesi için Cursor kuralları, Material UI ve Tailwind CSS entegrasyonu ile birlikte."
category: "Frontend"
repo: "PatrickJS/awesome-cursorrules"
stars: 40019
path: "rules/nextjs-material-ui-tailwind-css-cursorrules-prompt.mdc"
...
body_tr: |-
  ...
  Next.Js'ye dayanmaktadır ve tailwindcss, materialui, shadcn/ui ve aceternityui içermektedir

  Projenizin adı nedir? portfolio2
  ...
  `src/` dizini kullanmak ister misiniz? Evet

  App Router kullanmak ister misiniz? (önerilen) Evet
