...
description_tr: "Python geliştirme için Cursor kuralları ve GitHub entegrasyonu ile kurulum."
category: "Languages"
repo: "PatrickJS/awesome-cursorrules"
stars: 40019
path: "rules/python-github-setup-cursorrules-prompt-file.mdc"
  ...
  ```json
  {
      "general": {
          ...
          "architecture": {
              ...
              "principles": ["Tek Sorumluluk", "DRY"]
          }
      },
      
      "project_specific": {
          "use_framework": "Hiçbiri",
          ...
          "performance": {
              ...
              "performance_goals": {
                  "response_time": "dosya başına < 5 saniye",
      ...
      "context": {
          "codebase_overview": "İçerik analizi ve sınıflandırması için AI kullanan Python tabanlı dosya organizasyon aracı",
          "libraries": [
      ...
      "behavior": {
          ...
          "communication_tone": "Profesyonel ve özlü"
      }
  }
  ```
---
