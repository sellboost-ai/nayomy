...
body_tr: |-
  ...
  - Uygun migrasyonlar uygulayın
  - Uygun ilişki tanımlamaları kullanın
  - Uygun bağlantı yapılandırması yapın
  - Uygun seeding uygulayın
  - Uygun client kurulumu kullanın

  ## Prisma Modelleri
  - Uygun model adlandırması kullanın
  - Uygun ilişkiler uygulayın
  - Uygun alan türleri kullanın
  - Uygun indexleri tanımlayın
  - Uygun kısıtlamaları uygulayın
  - Uygun enumları kullanın

  ## Prisma Sorguları
  - Uygun sorgu optimizasyonu kullanın
  - Uygun filtreleme uygulayın
  - Uygun ilişki yüklemesi kullanın
  - İşlemleri uygun şekilde yönetin
  - Uygun sayfalandırma uygulayın
  - Uygun agregasyonları kullanın

  ## Supabase Kurulumu
  - Uygun proje kurulumunu yapılandırın
  - Uygun kimlik doğrulaması uygulayın
  - Uygun veritabanı kurulumunu kullanın
  - Uygun depolama yapılandırması yapın
  - Uygun politikalar uygulayın
  - Uygun client kurulumunu kullanın

  ## Supabase Güvenliği
  - Uygun RLS politikaları uygulayın
  - Uygun kimlik doğrulaması kullanın
  ...
  - Uygun sorgu optimizasyonu kullanın
  - Uygun filtreleme uygulayın
  - Uygun birleştirmeler kullanın
  - Gerçek zamanlı güncellemeleri uygun şekilde yönetin
  - Uygun sayfalandırma uygulayın
  - Uygun fonksiyonları kullanın

  ## Veritabanı Tasarımı
  - Uygun normalizasyonu kullanın
  - Uygun indexleme uygulayın
  - Uygun kısıtlamaları kullanın
  - Uygun ilişkileri tanımlayın
  - Uygun cascade operasyonlarını uygulayın
  - Uygun veri türlerini kullanın

  ## Performans
  - Uygun bağlantı havuzlamasını kullanın
  - Uygun önbelleği uygulayın
  - Uygun sorgu optimizasyonu kullanın
  - N+1 sorgularını uygun şekilde yönetin
  - Uygun toplu işlemeyi uygulayın
  ...
  - Uygun sürüm kontrolünü uygulayın
  - Hataları uygun şekilde yönetin
  - Şemayı düzgün belgelendirin
  - Veritabanı durumunu izleyin
---
